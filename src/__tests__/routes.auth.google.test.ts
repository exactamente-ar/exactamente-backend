...
describe('GET /api/v1/auth/google/callback', () => {
  it('redirige a /?error=oauth_denied cuando Google devuelve error', async () => {
  ...
  it('redirige a /?error=oauth_denied sin code ni error', async () => {
  ...
  it('redirige a /?error=oauth_failed si Google rechaza el code', async () => {
    global.fetch = mock(() =>
      Promise.resolve({
        ok: false,
